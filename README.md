  ...
  <body>
    ...
    <main>
      ...
      <section class="portfolio">
        ...
        <h3> Interactive choropleth map. PA scale. <br> Visualizes distribution of covid cases across all PA counties.<br>
        ...
        <h3> Interactive proportional symbol map embedded below. Global scale. <br> Conveys magnitude of covid death counts around the world through color-coded proportional symbols. <br>
