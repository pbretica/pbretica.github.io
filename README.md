  ...
  <body>
    ...
    <main>
      ...
      <section class="portfolio">
        ...
        <h3>Interactive choropleth map. <br> Visualizes distribution of covid cases across all PA counties. </h3>
        <a href="https://pbretica.github.io/worldcoviddeaths/" class="button2">Proportional Symbol Map</a> <br>
        <h4> Interactive map. <br> Conveys magnitude of covid death counts around the world through color-coded proportional symbols. </h4>
