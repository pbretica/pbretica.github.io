  ...
  <body>
    ...
    <main>
      ...
      <section class="portfolio">
        ...
        <h3><b> Interactive choropleth map. PA scale. <br> Visualizes distribution of covid cases across all PA counties.<b> </h3> <br>
        <img src="covidcases.png" alt="Choropleth map of PA covid cases by county" width="700" height="500">
        <hr>
        <br> <br> <a href="https://pbretica.github.io/worldcoviddeaths/" class="button2">Proportional Symbol Map</a> <br>
        <h3> <b> Interactive proportional symbol map embedded below. Global scale. <br> Conveys magnitude of covid death counts around the world through color-coded proportional symbols. <br> <b> </h3>
