  ...
  <body>
    ...
    <main>
      ...
      <section class="portfolio">
        ...
        <h3><b> Interactive choropleth map. PA scale. <br> Visualizes distribution of covid cases across all PA counties.<b> </h3>
        ...
        <h3> <b> Interactive proportional symbol map embedded below. Global scale. <br> Conveys magnitude of covid death counts around the world through color-coded proportional symbols. <b> </h3>
