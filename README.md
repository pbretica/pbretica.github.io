  ...
  <body>
    ...
    <main>
      ...
      <section class="portfolio">
        ...
        <h3> Interactive choropleth map showing distribution of covid cases across all counties in PA. <br> <br>
        <a href="https://pbretica.github.io/worldcoviddeaths/" class="button2">Proportional Symbol Map</a> <br> <br>
        Interactive map showing covid death counts around the world using proportional symbols. <br> <br>
